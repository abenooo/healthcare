      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-8">
          <div className="p-8">
            ...
            <div className="mb-6">
              <Link to="/services" className="inline-flex items-center text-gray-600 hover:text-gray-900 transition-colors">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="p-6">
                ...
                <div className="relative mb-6">
                  <img
                    src={
                      service.images[selectedImageIndex] || "/placeholder.svg"
                    }
                    alt={service.name}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 rounded-2xl p-6">
              ...
              <p className="text-gray-700 mb-6">
                Ready to learn more about our {service.name}? Contact us to
